package com.linqi.RiskCtrlSys.commons.constants;
...
public class ConstantsUtil {
     ...
     * 包路径
     */
    public static final String PACKAGE_DIR = "com/linqi/RiskCtrlSys";
     ...
     * 父包路径
     */
    public static final String PARENT_PACKAGE = "com.linqi.RiskCtrlSys";
     ...
     * 数据库url
     */
    public static final String MYSQL_URL = "jdbc:mysql://mysql:3306/linqi?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false"
    ;
    /**
     * 数据库用户名
     */
     ...
     * 作者
     */
    public static final String AUTHOR = "linqi";
    /**
     * 日期格式
     */
     ...
     */
    public static final String PATH_CLASS_METRIC_REDIS_FUNCTION = "com.linqi.RiskCtrlSys.flink.job.aviator.MetricRedisFunction";
